    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:credit.application_status_type", "application_received,approved,rejected")
                .Annotation("Npgsql:Enum:credit.credit_risk_level_type", "none,very_high_risk,high_risk,medium_risk,good,excellent")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    risk_level_type = table.Column<CreditRiskLevelType>(type: "credit.credit_risk_level_type", nullable: false, defaultValue: CreditRiskLevelType.None),
                    application_status = table.Column<ApplicationStatusType>(type: "credit.application_status_type", nullable: false, defaultValue: ApplicationStatusType.ApplicationReceived),
