    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:score.credit_risk_level_type", "none,very_high_risk,high_risk,medium_risk,good,excellent")
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0190d4db-25b9-4e34-bf03-737035a3e916"), new DateTime(2024, 8, 25, 12, 0, 0, 0, DateTimeKind.Utc), new Guid("e0f2f77a-b7d4-4b8a-9f35-b0f60d1bdf6e"), EntityStatusType.Active, 1599, 1400, CreditRiskLevelType.MediumRisk, null, null },
                    { new Guid("1f9e3b9e-1e44-4d6d-8f98-6bfa5e8c12ed"), new DateTime(2024, 8, 25, 11, 0, 0, 0, DateTimeKind.Utc), new Guid("e0f2f77a-b7d4-4b8a-9f35-b0f60d1bdf6e"), EntityStatusType.Active, 1199, 1000, CreditRiskLevelType.VeryHighRisk, null, null },
                    { new Guid("3d9f8d5e-6476-4dbe-85db-6d7879fc317d"), new DateTime(2024, 8, 25, 12, 0, 0, 0, DateTimeKind.Utc), new Guid("e0f2f77a-b7d4-4b8a-9f35-b0f60d1bdf6e"), EntityStatusType.Active, 1399, 1200, CreditRiskLevelType.HighRisk, null, null },
                    { new Guid("81f6a5c4-2c1e-4fed-9387-2774321feb30"), new DateTime(2024, 8, 25, 12, 0, 0, 0, DateTimeKind.Utc), new Guid("e0f2f77a-b7d4-4b8a-9f35-b0f60d1bdf6e"), EntityStatusType.Active, 1999, 1800, CreditRiskLevelType.Excellent, null, null },
                    { new Guid("fb14b253-61ea-4118-8e41-e8cddce4e0a3"), new DateTime(2024, 8, 25, 12, 0, 0, 0, DateTimeKind.Utc), new Guid("e0f2f77a-b7d4-4b8a-9f35-b0f60d1bdf6e"), EntityStatusType.Active, 1799, 1600, CreditRiskLevelType.Good, null, null }
                });
